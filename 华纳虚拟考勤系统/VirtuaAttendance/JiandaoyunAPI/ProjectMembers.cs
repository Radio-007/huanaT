...
{
    public partial class ProjectMembers : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void AttendancePerson_Load(object sender, EventArgs e)
        {
        ...
        private void btnQuery_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            this.CommonSQL = "select b.ID as ProjectID,b.OrgName,b.ProjectNo,b.ProjectName,a.ID,a.EmployeeNo,a.FullName,a.StartDate,a.EndDate,a.JobContent,cast(a.Ratio as varchar(10))+'%' as Ratio";
            this.CommonSQL += " ,a.CreateTime,c.Sex,c.Education,case when a.JobContent='全面负责' then 1 else 2 end as OrderNo ";
            this.CommonSQL += " from ProjectMembers a inner join Projects b on b.ProjectNo=a.ProjectNo left join Employees c on c.EmployeeNo=a.EmployeeNo ";
            this.CommonSQL += " where 1=1" + strFilter;
            this.CommonSQL += " order by a.ProjectNo,OrderNo";
