...
{
    public partial class Projects : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnQuery_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            if (dtDate1.Text.Trim() != "")
                strFilter += " and StartDate>='" + dtDate1.Text + "'";
            if (dtDate2.Text.Trim() != "")
                strFilter += " and StartDate<'" + dtDate2.Text + " 23:59:00'";

            this.CommonSQL = "select * from Projects where 1=1" + strFilter + " order by ProjectNo";
