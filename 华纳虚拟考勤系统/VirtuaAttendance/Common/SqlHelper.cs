...
namespace GxRadio.Common
{
    ...
    public class SqlHelper
    {
        ...
        {
            String connectionString = ConfigurationManager.AppSettings["DB.ConnectionString"].ToString();
            return SharePro.DecodeBase64(connectionString); //64位解密
        }
        #endregion
        ...
        public static int ExecuteSql(String Sqlstr) 
        {
            ...
            using (SqlConnection conn = new SqlConnection(ConnStr)) 
            {
                ...
                try
                {
                    cmd.CommandTimeout = 300; //默认30秒超时，大数据查询或计算时
                    cmd.Connection = conn;
