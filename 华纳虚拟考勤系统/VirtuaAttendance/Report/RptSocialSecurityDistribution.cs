...
{
    public partial class RptSocialSecurityDistribution : DevExpress.XtraEditors.XtraForm
    {
        private string CommonSQL;
        public RptSocialSecurityDistribution()
        {
            InitializeComponent();
        }
        ...
        {
            btnCalAttendance.Visibility = BarItemVisibility.Never;
            ...
            {
                //btnCalAttendance.Visibility = BarItemVisibility.Always;
            }
        }
        #endregion
        ...
        private void RptSocialSecurityDistribution_Load(object sender, EventArgs e)
        {
        ...
        private void btnQuery_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            strSql.Append("select *,case when JobContent='项目负责人' then 1 else 2 end as OrderNo from ProjectAttenSum");
            ...
            lblTitle.Text = cmbOrgName.Text + cmbYear.Text + "年" + cmbMonth.Text + "月社保分配表";
        }
