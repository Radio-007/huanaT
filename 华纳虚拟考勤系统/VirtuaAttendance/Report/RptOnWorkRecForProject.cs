...
{
    public partial class RptOnWorkRecForProject : DevExpress.XtraEditors.XtraForm
    {
        private RptWorkForProject pForm;
        public string OrgName = "";
        public string ProjectNo = "";
        public string ProjectName = "";
        public int sYear = 0;
        public int sMonth = 0;
        public RptOnWorkRecForProject(RptWorkForProject parentForm)
        {
            InitializeComponent();
        ...
        {
            string strSql = "exec RptOnWorkRecForProject '" + ProjectNo + "'," + sYear.ToString() + "," + sMonth.ToString();
            DataSet ds = SqlHelper.ExecuteDs(strSql);
            if (ds.Tables.Count == 0)
            {
                ds = SqlHelper.ExecuteDs("select WorkDate,Period,'' as 员工A,'' as 员工B,'' as 员工C,'' as 员工D,'' as 员工E from OnWorkRec where 1=0");
            }
