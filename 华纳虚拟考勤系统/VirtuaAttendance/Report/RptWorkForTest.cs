...
{
    public partial class RptWorkForTest : DevExpress.XtraEditors.XtraForm
    {
        private string CommonSQL;
        public RptWorkForTest()
        {
            InitializeComponent();
        }
        ...
        private void RptWorkForTest_Load(object sender, EventArgs e)
        {
        ...
        private void btnQuery_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            this.CommonSQL += " select ProjectNo from OnWorkRecForTest where 1=1 " + strFilter + " group by ProjectNo ";
        ...
        private void gridControl1_DoubleClick(object sender, EventArgs e)
        {
            ...
            RptOnWorkRecForTest dg = new RptOnWorkRecForTest(this);
