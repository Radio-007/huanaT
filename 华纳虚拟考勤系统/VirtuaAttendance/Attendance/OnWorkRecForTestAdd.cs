...
{
    public partial class OnWorkRecForTestAdd : DevExpress.XtraEditors.XtraForm
    {
        private OnWorkRecForTest pForm;
        public int RecordID = 0;
        public OnWorkRecForTestAdd(OnWorkRecForTest parentForm)
        {
            InitializeComponent();
        ...
        {
            string strSql = "select a.*,b.OrgName,b.Department,c.ProjectName from OnWorkRecForTest a inner join Employees b on b.EmployeeNo=a.EmployeeNo ";
        ...
        private bool validata()
        {
            ...
            string strSql = "select count(*) from OnWorkRecForTest where ProjectNo='" + txtProjectNo.Text+"' and EmployeeNo ='" + txtEmployeeNo.Text + "' and WorkDate='" + dtWorkDate.Text + "' and Period='" + cmbPeriod.Text + "' and ID!=" + Convert.ToString(this.RecordID);
            DataSet ds = SqlHelper.ExecuteDs(strSql);
        ...
        private void OnWorkRecForTestAdd_Load(object sender, EventArgs e)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (this.RecordID == 0)
            {
                string strSql = "insert into OnWorkRecForTest(ProjectNo, EmployeeNo, FullName, WorkDate, Period, Days, OnDesc, Remark, Status, Creator, CreateTime) values('";
            ...
            {
                string strSql = "UPDATE OnWorkRecForTest SET ProjectNo='" + txtProjectNo.Text + "',FullName = '" + txtFullName.Text + "',Days=" + txtDays.Text + ",OnDesc='" + cmbOnDesc.Text + "',Remark='" + txtRemark.Text.Trim() + "'";
