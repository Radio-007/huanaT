...
{
    public partial class OnWorkRecForTest : DevExpress.XtraEditors.XtraForm
    {
        private string CommonSQL;
        public OnWorkRecForTest()
        {
            InitializeComponent();
        }
        ...
        private void OnWorkRecForTest_Load(object sender, EventArgs e)
        {
        ...
        private void btnQuery_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            this.CommonSQL = "select a.*,b.OrgName,b.Department,b.Station,c.ProjectName from OnWorkRecForTest a inner join Employees b on b.EmployeeNo=a.EmployeeNo ";
        ...
        {
            OnWorkRecForTestAdd dg = new OnWorkRecForTestAdd(this);
            dg.RecordID = 0;
            dg.ShowDialog();
        }
